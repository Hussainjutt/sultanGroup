  ...
  return (
    <Layout>
      <Container>
        ...
        <Box>
          <h2>Privacy Policy for F. A Trader (Sultan Group) ®</h2>
          <p>
            At sultan group, accessible from www.sultangroup.org, one of our
            main priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by sultan group and how we use it.
            <br />
            ...
            that they shared and/or collect in sultan group. This policy is not
            applicable to any information collected offline or via channels
            other than this website. Our Privacy Policy was created by cooperate
            lawyer hired by our firm.
          </p>
        </Box>
        <Box>
          <h2>Consent</h2>
        ...
        <Box>
          <h2>Log Files</h2>
          <p>
            sultan group follows a standard procedure of using log files. These
        ...
        <Box>
          ...
          <p>
            ...
            advertising partners of sultan group.
            <br />
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on sultan group,
            ...
            <br />
            <br />
            Note that sultan group has no access to or control over these
        ...
        <Box>
          ...
          <p>
            sultan group's Privacy Policy does not apply to other advertisers or
        ...
        <Box>
          ...
          <p>
            ...
            <br />
            sultan group does not knowingly collect any Personal Identifiable
